# # 1.re 모듈의 메서드
import re
str ='love people around you, love your work, love myself'

# # 1) match: 문자열의 처음부터 결과(결과 : 1개의 match객체)
# result = re.match('love',str)
# print(result)

# # 2) search: 문자열의 전체를 검색 결과(결과 :1개 match 객체)
...
# # 5) fullmatch 패턴과 문자열이 완벽하게 일치 하는지 검사
...
# 4. spen(): 메칭된 문자열의 (시작,끝) 위치 튜플을 반환
print(result.span())
